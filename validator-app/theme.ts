...
export class Theme {
    static readonly primaryColor200Hex = '#69b7ff';
    static readonly primaryColor300Hex = '#0088FF'; // primary
    static readonly primaryColor900Hex = '#005ccb'; // darkest

    static readonly backgroundColorHex = '#121212';
    static readonly textColorHex = '#eeeeee';
